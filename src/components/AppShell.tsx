...
{/* Desktop-only nav */}
  <div className="hidden lg:block">
    <div className="mx-auto w-full max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-5xl px-4 h-10 flex items-center gap-4 text-sm">
      ...
      <NavLink to="/" end className={({isActive}) => isActive ? "text-primary font-medium" : "text-muted-foreground"}>Dashboard</NavLink>
      <NavLink to="/vehicles" className={({isActive}) => isActive ? "text-primary font-medium" : "text-muted-foreground"}>Vehicles</NavLink>
      <NavLink to="/records" className={({isActive}) => isActive ? "text-primary font-medium" : "text-muted-foreground"}>Records</NavLink>
      <NavLink to="/reports" className={({isActive}) => isActive ? "text-primary font-medium" : "text-muted-foreground"}>Reports</NavLink>
      </div>
    </div>
  </div>
